        ...
        <div className="flex justify-between flex-wrap gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <a
                href="https://apps.apple.com/app/flexcard"
                target="_blank"
          ...
          <div className="flex  flex-col gap-2 text-gray-400 max-w-7xl">
            <p>
              <span className="text-white ">
                © {new Date().getFullYear()} FlexCard Ltd. All rights reserved. -
              </span>
              "Flex: Pay For What You Owe" is a registered trademark of FlexCard Ltd.
            </p>
            <p>
              For further details about our policies and services, please refer to the links above
              or contact us.
            </p>
            <p>
              FlexCard Ltd (Company Number: XXXXXX) is authorised and regulated by the Financial
              Conduct Authority (FCA) under limited permissions for consumer lending (Firm Reference
              Number: XXXXXXX).
            </p>
            <p>
              FlexCard Ltd operates under FCA oversight for specific regulated activities, including
              consumer credit. This means we adhere to UK financial regulations while providing fair
              and transparent lending solutions.
            </p>
          </div>
