...
const BetaPerks = () => {
  ...
  return (
    <section className="bg-[#F2F4F8] py-8 md:py-12 lg:py-16">
      <Container>
        <HeaderNote title={'pay for what you owe'} note={'Exclusive Beta Perks'} />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {perks.map((perk, index) => (
            <div key={index} className="flex flex-col items-center py-4 md:py-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center py-10 md:py-16 lg:py-20">
          <p className="text-[#1D1D1D] text-xl md:text-2xl text-left w-full lg:w-1/2 mt-4 font-semibold leading-7 md:leading-8 mb-8 lg:mb-0">
            We tested, listened, and built FlexCard. Over 2,500 people were surveyed— 2/3 said they
            didn't understand how credit card interest works, 50% assumed interest is charged only
            on the remaining balance, and 80% didn't know that transactions outside statement cycles
