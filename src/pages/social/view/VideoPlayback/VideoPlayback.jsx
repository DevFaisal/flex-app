...
const VideoPlayback = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center px-0 sm:px-10 h-[75vh]">
      <div className="flex-1 md:rounded-3xl h-2/3 w-full p-10 flex justify-center items-center ">
        <iframe
