...
const CreditCardCalculator = () => {
  ...
  return (
    <section className="relative flex flex-col justify-center items-center p-4 md:p-10 max-w-5xl mx-auto">
      <HeaderNote
      ...
      <div className="p-4 md:p-6 border-[0.5px] border-gray-400 rounded-2xl bg-white z-[10] w-full max-w-xl">
        ...
        <div className="flex flex-col md:flex-row gap-3 mb-4">
          <div className="w-full md:w-1/2">
            ...
            <input
              ...
              className="w-full bg-[#F2F4F8] px-3 py-2 rounded-md outline-none appearance-none shadow-[0px_2px_0px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]"
            />
          </div>
          <div className="w-full md:w-1/2">
            <label htmlFor="" className="text-sm mb-2 block">
        ...
        {/* Divider */}
        <span className="block p-[1px] bg-gray-300 my-6"></span>
