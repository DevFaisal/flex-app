...
const NeedVideo = () => {
  return (
    <section className="py-20 flex flex-col md:flex-row md:h-[40vh]">
      <div className="flex-1 p-10 flex justify-center items-center">
        <h2>Video</h2>
      </div>
      <div className="flex-1 px-10 md:px-20 py-5 space-y-3.5">
        <h2 className="text-3xl font-bold">Need a video here from Sawan</h2>
        <p>
