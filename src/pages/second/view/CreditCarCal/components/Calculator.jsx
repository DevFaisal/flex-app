    ...
    <section className="flex flex-col md:flex-row justify-between items-start gap-10">
      <div className="w-full md:w-1/2">
        ...
        <p className="mt-4 text-gray-700  p-4 rounded-lg ">
          <strong>Recommendation:</strong> Based on your credit card usage, you
          could save significantly with FlexCard by only paying interest on what
          you actually owe.
        </p>
        {/* <button
      ...
      <div className="w-full md:w-1/2 flex flex-col items-start justify-center space-y-4  p-6 rounded-lg">
        ...
        <p className="text-gray-700">
          ...
          the money you've already paid back.
        </p>
        <Button
